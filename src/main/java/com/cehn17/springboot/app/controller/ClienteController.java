...
import com.cehn17.springboot.app.models.service.IClienteService;
import com.cehn17.springboot.app.models.service.IUploadFileService;
import com.cehn17.springboot.app.util.paginator.PageRender;
...
public class ClienteController {
	...
	public String ver(@PathVariable(value = "id") Long id, Map<String,Object> model, RedirectAttributes flash) {
		...
		if(cliente == null) {
			flash.addFlashAttribute("error","Eliente no existe en la BBDD");
